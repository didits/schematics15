            ...
            <ol>
                ...
                <li>
                    ...
                    <h3>Sederet kartu remi dengan angka terbilang dari 8 hingga As (7 kartu) tersusun dari kiri kekanan dengan aturan seperti berikut:
                        ...
                        Dari informasi diatas, maka dapat disimpulkan bahwa susunan kartu yang tepat adalah: 
                    </h3>
                ...
                <li>
                    ...
                    <img src="img/soal3.svg" style="width:250px;">
                ...
                <li>
                    ...
                    <h3>Satu hari Coreng sedang bermain listrik dengan teman sekamarnya yang bernama Fajar dari Jurusan Teknik Elektro. 
                        ...
                        <img src="img/soal4.1.svg" style="width:250px;">
                    <h3>Peraturan permainan lampu ini yaitu jika suatu tombol ditekan maka tombol dengan nama yang sama akan berubah dari mati ke hidup atau hidup ke mati, 
                        ...
                        Jika Fajar memberi pertanyaan ke Coreng, mana dari ke lima kemungkinan di bawah yang tidak bisa dibentuk dari 2 kali menekan tombol?
                    </h3>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-A" value="A" />
                        <label style="line-heigth:50px" for="question-5-answers-A">A) <img src="img/soal4.a.svg" style="width:150px;"></label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                        <label for="question-5-answers-B">B) <img src="img/soal4.b.svg" style="width:150px;"></label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                        <label for="question-5-answers-C">C) <img src="img/soal4.c.svg" style="width:150px;"></label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-D" value="D" />
                        <label for="question-5-answers-D">D) <img src="img/soal4.d.svg" style="width:150px;"></label>
                    </div>
                
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-E" value="E" />
                        <label for="question-5-answers-E">E) <img src="img/soal4.e.svg" style="width:150px;"></label>
                    </div>
                </li>

                <li>
                
                    <h3>3, 6, 11, 18, y, z, 59, 78. <br> Berapakah nilai z?</h3>
                ...
                <li>
                    ...
                    <h3>M, V, B, M, J, S, U, ? <br> Jawaban yang tepat untuk mengisi tanda tanya adalah… </h3>
                ...
                <li>
                    ...
                    <h3>Setelah perampokan Kantor Pos setempat, lima tersangka sedang diwawancarai.Di bawah ini adalah ringkasan laporan mereka.<br>
                        ...
                        Polisi tahu bahwa setiap dari mereka mengatakan kebenaran dalam salah satu pernyataan dan berbohong di lain. Dari informasi ini tentukan siapa yang melakukan kejahatan?
                    </h3>
                ...
                <li>
                    ...
                    <img src="img/soal10.svg" style="width:350px;">
